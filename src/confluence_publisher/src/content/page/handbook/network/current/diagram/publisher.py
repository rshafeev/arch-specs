from content.page.handbook.network.current.diagram.view import NetworkCurrentDiagramView
...
class NetworkCurrentDiagramPublisher(NetworkPagePublisherCore):
    __branch: Branch

    __html_templates_storage: HtmlTemplatesStorage

    __page_view: NetworkCurrentDiagramView
    ...
    def __init__(self,
        ...
        self.__page_view = NetworkCurrentDiagramView(html_templates_storage)

    @staticmethod
    def title(spec: ServiceSpecExt):
        return NetworkCurrentDiagramPageTitle.title(spec)
