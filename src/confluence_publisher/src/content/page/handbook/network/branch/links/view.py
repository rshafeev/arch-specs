...
class NetworkBranchLinksView:
    ...
    def __template(self, spec: ServiceSpecExt):
        if spec.is_broker:
            template_name = HtmlPageTemplateName.network_branch_broker_network_links
        else:
            template_name = HtmlPageTemplateName.network_branch_links
