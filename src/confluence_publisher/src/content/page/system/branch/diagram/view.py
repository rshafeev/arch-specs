...
class SystemNetworkBranchDiagramView:
    diagram_name = "system_arch_diagram"
    ...
    def __init__(self, html_templates_storage: HtmlTemplatesStorage):
        ...
        self.__template = html_templates_storage.get_page(HtmlPageTemplateName.system_network_branch_diagram)
